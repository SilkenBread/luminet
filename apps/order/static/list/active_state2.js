// ============================================================
// Order Active State 2 - En Terreno
// ============================================================
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-4 py-4 whitespace-nowrap">
                    <div class="flex items-center justify-center gap-1">
                        ...
                        <button onclick="returnToAssignment(${ot.id})"
...
function returnToAssignment(otId) {
    Swal.fire({
        title: '¿Devolver a Asignación?',
        text: `¿Deseas devolver la OT #${otId} al estado de asignación?`,
        icon: 'question',
